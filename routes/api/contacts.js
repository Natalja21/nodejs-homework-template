...
router.get("/:contactId", authenticate, isValidId, ctrlWrapper(ctrl.getByIdContact));
...
router.delete("/:contactId", authenticate, isValidId, ctrlWrapper(ctrl.removeByIdContact));
